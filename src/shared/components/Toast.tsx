...
export function ToastContainer() {
  ...
  return (
    <div style={{
      ...
      maxWidth: '360px', width: '90%', pointerEvents: 'none'
    }}>
      {toasts.map(t => (
        <div
          key={t.id}
          ...
          style={{
            ...
            borderLeft: `5px solid ${
              t.type === 'success' ? '#A3D045' : t.type === 'error' ? '#ef4444' : '#fbbf24'
            }`,
            color: '#f8fafc',
        ...
        >
          <span>
            {t.type === 'success' ? '✅' : t.type === 'error' ? '❌' : '⚠️'} {t.text}
          </span>
          <span style={{ opacity: 0.5, fontSize: '14px', marginLeft: '6px' }}>×</span>
        </div>
      ))}
      <style>{`
