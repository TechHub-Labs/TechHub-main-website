      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-[99px] py-16 sm:py-20 lg:pt-[99px] lg:pb-[40px]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col-reverse md:flex-row md:justify-between md:items-end gap-8">
            ...
            >
              <a
                href="https://instagram.com/nhtechhub"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://linkedin.com/company/nhtechhub"
                target="_blank"
                rel="noreferrer"
                className="hover:opacity-70 transition-opacity"
              >
              ...
              <a
                href="https://twitter.com/nhtechhub"
                target="_blank"
                rel="noreferrer"
                className="hover:opacity-70 transition-opacity"
              >
