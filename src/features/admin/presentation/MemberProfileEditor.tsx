...
export function MemberProfileEditor() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!year.trim()) {
      setSaving(false);
      return setError("Please provide your year.");
    }
  ...
  return (
    <div style={{ padding: "32px", maxWidth: "680px" }}>
      ...
      <p style={{ color: "#64748b", fontSize: "13px", marginBottom: "28px" }}>
        Your profile will appear on the Members page once an admin marks it
        visible.
      </p>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <AdminTextarea
          ...
          onChange={setQuote}
          required
          placeholder="A short quote about your journey…"
          rows={3}
        />
