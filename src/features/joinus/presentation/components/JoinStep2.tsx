...
export function JoinStep2({
  ...
  const trackBorderInactive = isDark
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-8">
        {TRACKS.map((t) => (
          <button
            ...
            style={{
              borderColor:
                track === t.label ? trackBorderActive : trackBorderInactive,
              background:
                track === t.label
                  ? isDark
                    ? "rgba(163,208,69,0.08)"
                    : "rgba(163,208,69,0.06)"
                  : "transparent",
              boxShadow:
                track === t.label ? "0 0 0 2px rgba(163,208,69,0.3)" : "none",
            }}
          >
            <div
      ...
      {errors.track && (
        <p className="text-xs mb-4 -mt-4" style={{ color: "#ef4444" }}>
          {errors.track}
        </p>
      )}
      ...
      <div className="mb-10 relative">
        <label className="block text-sm mb-1" style={{ color: labelColor }}>
          Why do you want to join TechHub?{" "}
        ...
        <div className="text-xs mt-1 flex justify-between">
          ...
          <span
            style={{
              color: reason.trim().length >= 100 ? "#A3D045" : labelColor,
            }}
          >
