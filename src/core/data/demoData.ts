...
export const DEMO_FEATURED_PROJECTS: DemoProject[] = [
  {
    ...
    about:
      "EventNav bridges the gap between event organizers and attendees on campus. It provides a centralized hub for discovering, booking, and managing university events with real-time updates.",
    about2:
      "Built with scalability in mind, it handles concurrent ticket bookings, QR code generation for check-ins, and analytics dashboards for organizers to track engagement.",
  ...
  },
  {
    ...
    about:
      "Designed to enhance the attendee experience, this app features real-time schedules, speaker bios, and interactive maps for the tech summit.",
    about2:
      "It includes a networking feature that allows attendees to connect based on shared interests and professional backgrounds.",
  ...
  },
  {
    ...
    about:
      "Campus Market eliminates the friction of finding buyers or sellers for textbooks, electronics, and dorm essentials within the university ecosystem.",
    about2:
      "The platform integrates verified student emails to ensure a secure and trusted trading environment.",
